    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="relative flex items-center justify-center" style={{ height: '40vh' }}>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center">
                    ...
                    <img
                        ...
                        className="relative z-30 mx-auto w-1/2 md:w-1/3 h-auto"
                        alt="ATO"
                    />
                </div>
            </div>
            ...
            <div className="flex flex-col items-center mb-10">
                <div className="flex flex-row justify-center gap-4 mt-4 w-[90%] overflow-x-auto">
                    <div className="w-full md:w-1/3 flex-shrink-0">
                        <img src="/images/athletic1.jpg" className="w-full h-full object-cover rounded-lg shadow-lg" alt="Athletic Activities" />
                    </div>
                    <div className="w-full md:w-1/3 flex-shrink-0">
                        <img src="/images/Paintball.jpg" className="w-full h-full object-cover rounded-lg shadow-lg" alt="Paintball Activities" />
                    </div>
                    <div className="w-full md:w-1/3 flex-shrink-0">
                        <img src="/images/RCR1.jpeg" className="w-full h-full object-cover rounded-lg shadow-lg" alt="RCR Activities" />
                    </div>
                </div>
            </div>
